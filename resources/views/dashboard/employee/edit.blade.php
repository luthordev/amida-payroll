        ...
        <div class="row">
            <div class="col">
                <div class="form-group mt-2">
                    ...
                    <input type="number" name="nik" id="nik" class="form-control" value="{{$e->nik}}" required />
                </div>
                <div class="form-group mt-2">
                ...
                <div class="form-group mt-2">
                    ...
                    <input type="number" name="no_bank_account" id="no_bank_account" class="form-control"
                        value="{{$e->no_bank_account}}" required />
                </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="form-group mt-2">
                    ...
                    <select name="position" id="position" class="form-control" required>
                        ...
                        <option value="{{$p->id}}" {{ $e->position_id == $p->id ? 'selected' : '' }}>{{$p->position}}
                        </option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group mt-2">
                    ...
                    <select name="division" id="division" class="form-control" required>
                        ...
                        <option value="{{$d->id}}" {{ $e->division_id == $d->id ? 'selected' : '' }}>{{$d->division}}
                        </option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group mt-2">
                    ...
                    <select name="status" id="status" class="form-control" required>
                        ...
                        <option value="Tetap" {{ $e->status == 'Tetap' ? 'selected' : '' }}>Tetap</option>
                        <option value="PKWT" {{ $e->status == 'PKWT' ? 'selected' : '' }}>PKWT</option>
                    </select>
                </div>
            </div>
        </div>
